(function() {
    ...
    for (var i=1; i< arguments.length; i++){
      if (typeof arguments[i] === 'object'){
        for ( var item in arguments[i] ){
          returnObj[item] = arguments[i][item];
        }
      }
    }
    return returnObj;
  ...
  _.defaults = function(obj) {
    ...
    for (var i=1; i< arguments.length; i++){
      if (typeof arguments[i] === 'object'){
        for ( var item in arguments[i] ){
          if ( returnObj.hasOwnProperty(item) === false){
            returnObj[item] = arguments[i][item];
          }
        }
      }
  ...
  _.shuffle = function(array) {
    ...
    while( currentIndex !== 0){
      ...
      var temp = returnArr[currentIndex];
      returnArr[currentIndex] = returnArr[randomIndex];
      returnArr[randomIndex] = temp;
    }
